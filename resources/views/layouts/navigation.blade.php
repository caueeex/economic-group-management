<nav x-data="{ open: false }" class="bg-white/90 backdrop-blur-sm border-b border-gray-100 shadow-sm">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('economic-groups.index')" :active="request()->routeIs('economic-groups.*')" class="flex items-center space-x-2">
                        <i class="fas fa-building"></i>
                        <span>{{ __('Grupos Econômicos') }}</span>
                    </x-nav-link>
                    
                    <x-nav-link :href="route('brands.index')" :active="request()->routeIs('brands.*')" class="flex items-center space-x-2">
                        <i class="fas fa-tags"></i>
                        <span>{{ __('Marcas') }}</span>
                    </x-nav-link>
                    
                    <x-nav-link :href="route('units.index')" :active="request()->routeIs('units.*')" class="flex items-center space-x-2">
                        <i class="fas fa-map-marker-alt"></i>
                        <span>{{ __('Unidades') }}</span>
                    </x-nav-link>
                    
                    <x-nav-link :href="route('employees.index')" :active="request()->routeIs('employees.*')" class="flex items-center space-x-2">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('economic-groups.index')" :active="request()->routeIs('economic-groups.*')" class="flex items-center space-x-2">
                <i class="fas fa-building"></i>
                <span>{{ __('Grupos Econômicos') }}</span>
            </x-responsive-nav-link>
            
            <x-responsive-nav-link :href="route('brands.index')" :active="request()->routeIs('brands.*')" class="flex items-center space-x-2">
                <i class="fas fa-tags"></i>
                <span>{{ __('Marcas') }}</span>
            </x-responsive-nav-link>
            
            <x-responsive-nav-link :href="route('units.index')" :active="request()->routeIs('units.*')" class="flex items-center space-x-2">
                <i class="fas fa-map-marker-alt"></i>
                <span>{{ __('Unidades') }}</span>
            </x-responsive-nav-link>
            
            <x-responsive-nav-link :href="route('employees.index')" :active="request()->routeIs('employees.*')" class="flex items-center space-x-2">
                <i class="fas fa-users"></i>
                <span>{{ __('Funcionários') }}</span>
            </x-responsive-nav-link>
